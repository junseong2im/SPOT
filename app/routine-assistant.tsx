...
export function RoutineAssistant({open,onClose,routine,onImport,onEdit,busy=false,serverError}:Props){
 ...
 const unresolved=draft?.routines.flatMap(r=>r.exercises).some(e=>!e.name.trim()||e.name.length>60||e.sets==null||e.reps==null||e.sets<1||e.sets>30||e.reps<1||e.reps>100||(e.durationSeconds!==undefined&&(e.durationSeconds===null||e.durationSeconds<1||e.durationSeconds>3600)));
